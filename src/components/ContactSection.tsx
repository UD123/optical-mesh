...
const ContactSection = () => {
  return <Section id="contact" className="bg-background" withDivider>
      <div className="max-w-3xl mx-auto bg-primary p-12 text-primary-foreground">
        ...
        <p className="text-primary-foreground/80 mb-8 font-light animate-fade-in">Interested in a demo, integration, or pilot deployment of Optical Mesh? Reach us at info@robotai.info or send a message below.</p>
